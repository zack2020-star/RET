...
detection_pkl_path = '/media/zack/WD_BLACK/a-swin-a/work_dirs/results_11.pkl'
val_json = '/home/zack/Desktop/test.json'

outpath = '/home/zack/Desktop/vis_result/'
inputpath = '/home/zack/Desktop/test/'
                    ...
                    if len(bboxes[iter_box])>0:
                        ...
                        for bbox in bboxes[iter_box]:
                            ...
                            if confidence > 0.3:
                                ...
                                #     # learning points
                                #     cv2.circle(image, (int(pt_x[i]), int(pt_y[i])), 1, r_color, thickness=2)
