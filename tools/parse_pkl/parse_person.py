...
detection_pkl_path = '/home/bai/a-swin-a/work_dirs/results_5l.pkl'
val_json = '/home/bai/a-swin-a/data/cepdof_train/test.json'

result_raw_outpath = '/home/bai/a-swin-a/txt_out/results/'
    ...
    with open(val_json) as f:
        ...
        for img_item in ann['images']:
            if iter_img + 1 == img_item['id']:
                ...
                img_base_name = img_name.split('.jpg')[0]
                bboxes = img_results
                    ...
                    if len(bboxes[iter_box]) > 0:
                        ...
                        for bbox in bboxes[iter_box]:
                            ...
                            if class_name == 'person':
                                with open('/home/bai/a-swin-a/txt_out/results/Task1_person.txt', 'a+') as f:

                                    f.write(img_base_name + ' ' + str(confidence) + ' ' + str(bbox[-9]) + ' ' + str(
                                        bbox[-8]) + ' ' + str(
                                        bbox[-7]) + ' ' + str(bbox[-6]) + ' ' + str(bbox[-5]) + ' ' + str(
                                        bbox[-4]) + ' ' + str(bbox[-3]) + ' ' + str(
                                        bbox[-2]) + '\n')
