...
def DOTA2COCOTest(srcpath, destfile, cls_names):
    imageparent = os.path.join(srcpath)
    data_dict = {}
...
if __name__ == '__main__':
    ...
    #               r'/mnt/SSD/lwt_workdir/s2anet_branch/data/dota_1024_ms_s2anet/trainval_split/trainval_coco_8points.json',
                 # wordname_15)
    DOTA2COCOTrain(r'/media/zack/WD_BLACK/Dataset/CEPDOF/CEPDOF/',
                r'/media/zack/WD_BLACK/Dataset/CEPDOF/CEPDOF/trainval.json',
               wordname_1)
    DOTA2COCOTest(r'/media/zack/WD_BLACK/Dataset/CEPDOF/CEPDOF/test_images',
                 r'/media/zack/WD_BLACK/Dataset/CEPDOF/CEPDOF/test.json',
                 wordname_1)
